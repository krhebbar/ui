...
/**
 * Recommendations at DevRev.
 */
export class Recommendations {
    constructor(protected readonly _options: Recommendations.Options = {}) {}

    /**
     * Gets a reply for a user query.
     *
     * @param {DevRev.GetReplyRequest} request
     * @param {Recommendations.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public async getReply(
    ...
    ): Promise<DevRev.GetReplyResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.GetReplyRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return serializers.GetReplyResponse.parseOrThrow(_response.body, {
