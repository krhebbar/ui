...
export declare namespace Keyring {
    interface Options {
...
/**
 * DevRev secrets interactions.
 */
export class Keyring {
    constructor(protected readonly _options: Keyring.Options = {}) {}

    /**
     * OAuth2 authorization callback.
     *
     * @param {DevRev.KeyringsCreateCallbackRequest} request
     * @param {Keyring.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *     })
     */
    public async keyringsCreateCallbackPost(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.KeyringsCreateCallbackRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
