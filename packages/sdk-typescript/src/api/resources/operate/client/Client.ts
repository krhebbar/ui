...
/**
 * DevRev incident management interactions.
 */
export class Operate {
    constructor(protected readonly _options: Operate.Options = {}) {}

    /**
     * Creates an incident.
     *
     * @param {DevRev.IncidentsCreateRequest} request
     * @param {Operate.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public async incidentsCreate(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.IncidentsCreateRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return serializers.IncidentsCreateResponse.parseOrThrow(_response.body, {
     ...
     * Deletes an incident.
     *
     * @param {DevRev.IncidentsDeleteRequest} request
     * @param {Operate.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link DevRev.BadRequestError}
     * @throws {@link DevRev.UnauthorizedError}
     ...
     *     })
     */
    public async incidentsDelete(
        request: DevRev.IncidentsDeleteRequest,
        requestOptions?: Operate.RequestOptions
    ): Promise<DevRev.IncidentsDeleteResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.DevRevEnvironment.Default,
                "incidents.delete"
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.IncidentsDeleteRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return serializers.IncidentsDeleteResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
     ...
     * Gets an incident.
     *
     * @param {DevRev.IncidentsGetRequest} request
     * @param {Operate.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link DevRev.BadRequestError}
     * @throws {@link DevRev.UnauthorizedError}
     ...
     *     })
     */
    public async incidentsGetPost(
        request: DevRev.IncidentsGetRequest,
        requestOptions?: Operate.RequestOptions
    ): Promise<DevRev.IncidentsGetResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.DevRevEnvironment.Default,
                "incidents.get"
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.IncidentsGetRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return serializers.IncidentsGetResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
     ...
     *
     * @param {DevRev.IncidentsGroupRequest} request
     * @param {Operate.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link DevRev.BadRequestError}
     * @throws {@link DevRev.UnauthorizedError}
     ...
     *     })
     */
    public async incidentsGroupPost(
        request: DevRev.IncidentsGroupRequest,
        requestOptions?: Operate.RequestOptions
    ): Promise<DevRev.IncidentsGroupResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.DevRevEnvironment.Default,
                "incidents.group"
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.IncidentsGroupRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return serializers.IncidentsGroupResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
     ...
     * Lists incidents.
     *
     * @param {DevRev.IncidentsListRequest} request
     * @param {Operate.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link DevRev.BadRequestError}
     * @throws {@link DevRev.UnauthorizedError}
     ...
     */
    public async incidentsListPost(
        request: DevRev.IncidentsListRequest = {},
        requestOptions?: Operate.RequestOptions
    ): Promise<DevRev.IncidentsListResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.DevRevEnvironment.Default,
                "incidents.list"
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.IncidentsListRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return serializers.IncidentsListResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
     ...
     * Updates an incident.
     *
     * @param {DevRev.IncidentsUpdateRequest} request
     * @param {Operate.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link DevRev.BadRequestError}
     * @throws {@link DevRev.UnauthorizedError}
     ...
     *     })
     */
    public async incidentsUpdate(
        request: DevRev.IncidentsUpdateRequest,
        requestOptions?: Operate.RequestOptions
    ): Promise<DevRev.IncidentsUpdateResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.DevRevEnvironment.Default,
                "incidents.update"
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.IncidentsUpdateRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return serializers.IncidentsUpdateResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
