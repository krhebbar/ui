...
export class CodeChanges {
    ...
    ): Promise<DevRev.CodeChangesCreateResponse> {
    ...
    public async delete(
        ...
        requestOptions?: CodeChanges.RequestOptions
    ): Promise<DevRev.CodeChangesDeleteResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.DevRevEnvironment.Default,
                "code-changes.delete"
    ...
    public async getPost(
        ...
        requestOptions?: CodeChanges.RequestOptions
    ): Promise<DevRev.CodeChangesGetResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.DevRevEnvironment.Default,
                "code-changes.get"
    ...
    public async listPost(
        ...
        requestOptions?: CodeChanges.RequestOptions
    ): Promise<DevRev.CodeChangesListResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.DevRevEnvironment.Default,
                "code-changes.list"
    ...
    public async update(
        ...
        requestOptions?: CodeChanges.RequestOptions
    ): Promise<DevRev.CodeChangesUpdateResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.DevRevEnvironment.Default,
                "code-changes.update"
