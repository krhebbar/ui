...
export class ServiceAccounts {
     ...
     *
     * @param {DevRev.ServiceAccountsGetRequest} request
    ...
    public async getPost(
    ...
    ): Promise<DevRev.ServiceAccountsGetResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.ServiceAccountsGetRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return serializers.ServiceAccountsGetResponse.parseOrThrow(_response.body, {
