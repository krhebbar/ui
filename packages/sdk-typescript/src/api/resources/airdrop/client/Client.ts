...
export class Airdrop {
    constructor(protected readonly _options: Airdrop.Options = {}) {}

    /**
     * Gets a single sync unit's information.
     *
     * @param {DevRev.AirdropSyncUnitsGetRequest} request
     * @param {Airdrop.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public async syncUnitsGetPost(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.AirdropSyncUnitsGetRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return serializers.AirdropSyncUnitsGetResponse.parseOrThrow(_response.body, {
     ...
     *
     * @param {DevRev.AirdropSyncUnitsHistoryRequest} request
     * @param {Airdrop.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link DevRev.BadRequestError}
     * @throws {@link DevRev.UnauthorizedError}
     ...
     *     })
     */
    public async syncUnitsHistoryPost(
        request: DevRev.AirdropSyncUnitsHistoryRequest,
        requestOptions?: Airdrop.RequestOptions
    ): Promise<DevRev.AirdropSyncUnitsHistoryResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.DevRevEnvironment.Default,
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.AirdropSyncUnitsHistoryRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return serializers.AirdropSyncUnitsHistoryResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
