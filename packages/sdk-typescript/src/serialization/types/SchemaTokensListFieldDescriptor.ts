...
export const SchemaTokensListFieldDescriptor: core.serialization.ObjectSchema<
    serializers.SchemaTokensListFieldDescriptor.Raw,
...
export declare namespace SchemaTokensListFieldDescriptor {
