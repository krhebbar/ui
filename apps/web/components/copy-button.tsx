...
interface CopyWithClassNamesProps extends React.HTMLAttributes<HTMLButtonElement> {
  value: string
  classNames: string
  className?: string
}
...
interface CopyNpmCommandButtonProps extends React.HTMLAttributes<HTMLButtonElement> {
